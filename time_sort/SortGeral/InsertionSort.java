...
public class InsertionSort {
    public static void main(String[] args){
        ...
        System.out.println("InsertionSort (20)");
        for(int i=0; i<1; i++){
        ...
        System.out.println("InsertionSort (30)");
        for(int i=0; i<1; i++){
        ...
        System.out.println("InsertionSort (40)");
        for(int i=0; i<1; i++){
        ...
        /*
        System.out.printf("InsertionSort (" + String.format("%,d", limite[0])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("InsertionSort (" + String.format("%,d", limite[1])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("InsertionSort (" + String.format("%,d", limite[2])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("InsertionSort (" + String.format("%,d", limite[4])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("InsertionSort (" + String.format("%,d", limite[5])+")");
        System.out.println();
        for(int i=0; i<10; i++){
