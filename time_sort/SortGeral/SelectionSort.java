...
public class SelectionSort {
    ...
    /*
        System.out.println("SelectionSort (20)");
        for(int i=0; i<1; i++){
        ...
        System.out.println("SelectionSort (30)");
        for(int i=0; i<1; i++){
        ...
        System.out.println("SelectionSort (40)");
        for(int i=0; i<1; i++){
    ...
    */
        ...
        System.out.printf("SelectionSort (" + String.format("%,d", limite[1])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("SelectionSort (" + String.format("%,d", limite[2])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("SelectionSort (" + String.format("%,d", limite[3])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("SelectionSort (" + String.format("%,d", limite[4])+")");
        System.out.println();
        for(int i=0; i<10; i++){
        ...
        System.out.printf("SelectionSort (" + String.format("%,d", limite[5])+")");
        System.out.println();
        for(int i=0; i<10; i++){
